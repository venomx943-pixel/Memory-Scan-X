Memory-Scan-Xis a lightweight, low-level security utility written in C. It is designed to identify potential security risks within a Linux system by scanning process memory maps for suspicious permissions.
